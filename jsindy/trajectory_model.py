...
from jsindy.util import l2reg_lstsq,row_block_diag
from jsindy.kernels import (
    Kernel,fit_kernel,ScalarMaternKernel,ConstantKernel,softplus_inverse,fit_kernel_partialobs
)
...
class RKHSInterpolant(TrajectoryModel):
    ...
    def initialize_partialobs(
        self,t,y,v,t_colloc,params,sigma2_est = None,
    ):
        params['sigma2_est'] = sigma2_est
...
class CholRKHSInterpolant(TrajectoryModel):
    ...
    def attach_partialobs(self,t_obs,y,v, basis_time_points):
        ...
        self.RKHS_mat = self.RKHS_mat + self.nugget * diagpart(self.RKHS_mat)
        self.cholT = cholesky(self.RKHS_mat + self.nugget * diagpart(self.RKHS_mat),lower = False)
